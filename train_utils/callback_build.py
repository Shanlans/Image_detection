...
def callback_build(val_data_generate,batch_size,log_dir='./logs', tb_mode='batch', tb_period=20, save_ckpt_period=1,
                   ckpt_monitor='val_acc', lr_monitor='val_loss', clear_log=True):
    """
    ...
    fullVal = FullEvaluate(validation_data=val_data_generate,batch_size=batch_size,log_dir=validation_result_dir)
